...
export default function Remote() {
    return(<section className='flex flex-col md:flex-row  px-5 py-5 bg-primary' id="remote">
      ...
      <FaBlogger size={25} className="mr-2"/>Digital Marketing (BLOGS)</h1>
        ...
        <a href="https://wa.me/<917094988549>?text=Hi" className=" w-[185px] hover:text-gray-400 text-white text-1xl mb-5 w-[250px] flex items-center"><FaWhatsappSquare size={20} className="text-white mr-2" /> Whatapp</a>
        </div>
